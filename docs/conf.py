...
project = 'PixHomology'
copyright = '2024, Riccardo Ceccaroni'
...
release = os.environ['GIT_DESCRIBE_TAG']
...
htmlhelp_basename = 'pixhomologydoc'
...
latex_documents = [
    (master_doc, 'pixhomology.tex', 'Documentation',
...
man_pages = [
    (master_doc, 'PixHomology', 'Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PixHomology', 'Documentation',
     author, 'PixHomology', 'One line description of project.',
     'Miscellaneous'),
]
